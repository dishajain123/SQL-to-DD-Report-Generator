...
class Settings:
    ...
    llm_model_name: str = os.getenv("GPT_MODEL") or os.getenv("LLM_MODEL_NAME", "")
    llm_base_url: str = os.getenv("LLM_BASE_URL", "")
    llm_synthesis_max_tokens: int = int(os.getenv("LLM_SYNTHESIS_MAX_TOKENS", "1024"))
    ...
    canonical_model_max_workers: int = int(os.getenv("CANONICAL_MODEL_MAX_WORKERS", "4"))
    dd_generation_max_attempts: int = int(os.getenv("DD_GENERATION_MAX_ATTEMPTS", "2"))
